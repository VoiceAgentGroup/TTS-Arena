...
def generate_tts():
    ...
    try:
        ...
        def process_model(model):
            ...
            # Create a unique name in the temp directory for the session
        ...
        app.logger.error(f"TTS generation error: {str(e)}", exc_info=True)
...
# TTS cache endpoints have been removed
